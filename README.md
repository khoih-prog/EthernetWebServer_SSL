...
3. [OPEnSLab-OSU's SSLClient](https://github.com/OPEnSLab-OSU/SSLClient)
...
3. Install [**EthernetWebServer_SSL** library](https://platformio.org/lib/show/xxxxx/EthernetWebServer_SSL) by using [Library Manager](https://platformio.org/lib/show/xxxxx/EthernetWebServer_SSL/installation). Search for EthernetWebServer_SSL in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
...
The following info is taken from [SSLClient README](https://github.com/OPEnSLab-OSU/SSLClient/blob/master/README.md)
...
* `client` - An instance of the EthernetClient class you are using for EthernetSSLClient. It is important that this instance be stored *outside* the `EthernetSSLClient` declaration (for instance, `EthernetSSLClient(EthernetClient() ...)` wouldn't work).
...
For more information on `EthernetSSLClient`, check out the [examples](./examples), [API documentation](https://openslab-osu.github.io/SSLClient/html/index.html), or the rest of this README.
